...
{
    private static readonly IVariableLengthWriter<(string ItemName, string Plat, string Ducats, string Volume, bool Vaulted, string Owned, string PartsDetected)> writer;
    ...
    {
        writer = new VariableLengthWriterBuilder<(string ItemName, string Plat, string Ducats, string Volume, bool Vaulted, string Owned, string PartsDetected)>()
        ...
        string partsDetected)
    {
        ...
        textWriter.WriteRecords(items, writer.TryFormat, ParallelOptions);
    }
