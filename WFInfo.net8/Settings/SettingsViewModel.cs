...
public class SettingsViewModel : INPC, INotifyDataErrorInfo
{
    ...
    public double MaximumEfficiencyValue
    {
        ...
        set
        {
            ...
            {
                _validationErrors.Add(nameof(MaximumEfficiencyValue),
                    "Maximum efficiency cannot be less than minimum efficiency");
            }
            else
            {
    ...
    public double MinimumEfficiencyValue
    {
        ...
        set
        {
            ...
            {
                _validationErrors[nameof(MinimumEfficiencyValue)] =
                    "Minimum efficiency cannot be greater than maximum efficiency";
            }
            else
            {
    ...
    public bool CF_usePrimaryHSL
    {
        get => _settings.CF_usePrimaryHSL;
        set
        {
